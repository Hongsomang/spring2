		...
		<div>
			<form>
				<div class="row">
					...
					<div class="col-1" >
						<input  name="minPrice" type="number" class="form-control form-control-sm" placeholder="이전금액">
					</div>
					<div class="col-1" >
						<label>~</label>
					</div>
					<div class="col-1 " >
						<input name="maxPrice" type="number" class="form-control form-control-sm" placeholder="이후금액">
					</div>
					<div class="col-1 ">
						<label >카테고리</label>
					</div>	
					<div class="col-1 ">
						<select name="keyword" class=" form-select-sm form-select ">
